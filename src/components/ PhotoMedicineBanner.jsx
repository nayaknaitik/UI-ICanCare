...
const PhotoMedicineBanner = () => {
  return (
    <div
      className="w-full bg-[#DAF0FF] py-12 px-8 flex flex-row md:flex-row items-center font-[poppins] mt-24"
    >
      <div className="w-full max-w-7xl mx-auto flex flex-row md:flex-row items-center justify-between gap-8">
        {/* Text Section */}
        <p className="text-sm md:text-3xl  font-semibold text-left mb-4 md:mb-0 md:flex-1 md:ml-8">
        ...
        <a
          href="oral-treatment"
          className="bg-[#2987D7] text-white md:mr-8 font-semibold md:text-xl px-5 py-1 md:px-8 md:py-4 rounded-lg shadow-lg hover:scale-105 transition-transform text-center"
        >
