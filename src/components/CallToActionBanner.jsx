  ...
  return (
    ...
    >
      <div className="w-full max-w-7xl mx-auto flex flex-row md:flex-row items-center justify-between gap-3 md:gap-8">
        {/* Text Section */}
        <p className="text-sm md:text-3xl font-semibold md:leading-8 leading-4 text-left mb-4 md:mb-0 md:flex-1 ml-3 md:ml-8">
        ...
        <a
          href="appoinment"
          className="bg-[#2987D7] text-[10px] text-white md:mr-8 font-semibold md:text-3xl px-7 py-1 md:px-12 md:py-4 rounded-lg shadow-lg hover:scale-105 transition-transform text-center"
        >
