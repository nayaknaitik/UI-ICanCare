      ...
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-8">
        ...
        <div className="flex-1 text-center md:text-left md:ml-6 max-w-full md:max-w-[700px]">
          ...
          <div className="mt-8 flex gap-2 md:gap-4 justify-center md:justify-start">
            <a
              href="#quit-now"
              className="bg-[#2987D7] text-[13px] text-white px-6 py-3 rounded-full font-medium hover:bg-[#005fa3] transition hover:scale-[105%] cursor-pointer inline-block text-center"
            >
            ...
            <a
              href="#know-more"
              className="border border-black text-[13px] px-6 py-3 rounded-full font-medium hover:bg-gray-100 transition hover:scale-[105%] cursor-pointer inline-block text-center"
            >
              Know More
            </a>
          </div>
        ...
        <div className="flex-1 flex justify-center md:justify-end">
          <img src={heroImage} alt="Hero" className="w-full max-w-lg md:max-w-xl object-cover" />
        </div>
