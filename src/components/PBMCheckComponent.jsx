  ...
  return (
    <div className="w-full bg-[#F8FBFF] py-5 md:py-16 px-4 md:px-8 font-[Poppins]">
      <div className="max-w-5xl mx-auto flex flex-row md:flex-row justify-between items-center">
        <div className="text-left ml-4 md:ml-0  md:mb-0">
          <h2 className="text-left md:text-center text-xs md:text-4xl font-semibold tracking-tighter text-[#2987D7] mb-">
            Check If PBM is Right for You!
          </h2>
          <h3 className="text-xs md:text-4xl font-semibold text-black">
        ...
        <a 
          href="tel:9773856664"
          className="bg-[#2987D7] text-white text-sm md:text-3xl font-bold px-2 py-2 md:px-8 md:py-4 rounded-xl shadow-lg hover:bg-[#2476BC] transition-colors duration-300 flex items-center gap-3"
        >
