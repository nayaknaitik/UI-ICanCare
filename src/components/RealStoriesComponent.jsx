        ...
        >
            <div className="flex flex-col md:flex-row items-center max-w-6xl w-full px-6 md:px-12">
                ...
                >
                    ...
                    <div className="flex md:justify-start md:gap-4">
                        <a href="oral-treatment" className='mx-auto md:mx-0'><button className="bg-[#2987D7] text-white md:px-6 md:py-3 px-2 py-2.5 rounded-lg md:text-base text-[10px] font-semibold">Learn About PBM</button></a>
                        <a href="/appointment" className='mx-auto  md:mx-0'><button className="border-2 border-[#2987D7] text-[#2987D7] md:px-6 md:py-2.5 px-2 py-2 rounded-lg md:text-base text-[10px] font-semibold">Talk to an Expert</button></a>
                    </div>
                </div>
                <div
